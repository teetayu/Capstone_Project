...
# -*- coding: utf-8 -*-
"""
XGBoost Regression for Poverty Percent forecasting
- ใช้ Year เป็น feature เดียว
"""
...
def train_and_evaluate(
    ...
    if plot:
        ...
        plt.title(f"XGBoost Forecast for {area_name}")
        plt.xlabel("Year")
...
def main():
    ...
    print(f" Training XGBoost for: {area}")
